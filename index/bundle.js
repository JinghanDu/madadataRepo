...
/***/ function(module, exports, __webpack_require__) {
	...
	var StockBox = React.createClass({
	  ...
	  loadStocksFromServer: function loadStocksFromServer() {
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	      cache: false,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        '日期',
	        React.createElement('input', { type: 'text', value: this.state.stockDate,
	...
	var StockResult = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var stockNodes = this.props.data.map(function (sInfo) {
	      return React.createElement(
	        Stock,
	        { stockDate: sInfo.stockDate, key: sInfo.id },
	        sInfo.stockName
	      );
	    });
	...
	var Stock = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      this.props.children,
	      ' on the date of ',
	      this.props.stockDate,
	      '.'
	    );
	  }
	});

	ReactDOM.render(React.createElement(StockBox, { url: 'http://localhost:3000/data' }), document.getElementById('main'));
